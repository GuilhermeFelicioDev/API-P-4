...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Comment c1 = new Comment(null, Instant.parse("2019-06-20T19:53:07Z"),"e ae cara", o1,u1);
		Comment c2 = new Comment(null, Instant.parse("2019-07-22T15:23:22Z"),"(34)98888-8888", o3,u1);
		Comment c3 = new Comment(null,Instant.parse("2019-07-22T15:27:22Z"),"(34)97777-7777",  o3,u1); 
